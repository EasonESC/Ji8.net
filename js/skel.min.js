...
var skel = (function () {
  var _ = {
    config: {
      ...
      useDomainLock: !0,
      containers: 960,
      grid: {collapse: !1, gutters: 40},
      breakpoints: {all: {range: '*', hasStyleSheet: !1}},
      events: {},
    },
    isConfigured: !1,
    isInit: !1,
    ...
    events: [],
    plugins: {},
    cache: {elements: {}, states: {}},
    locations: {html: null, head: null, body: null},
    vars: {},
    lsc: '_skel_lock',
    sd: ' ',
    css: {
      ...
      standard: {
        breakpoints: {
          mobile: {
            ...
            lockViewport: !0,
            containers: 'fluid',
            grid: {collapse: 1, gutters: 10},
          },
          desktop: {range: '481-', containers: 1200},
          '1000px': {range: '481-1200', containers: 960},
        },
      },
    },
    defaults: {
      breakpoint: {test: null, config: null, elements: null},
      config_breakpoint: {
        range: '',
        containers: 960,
        lockViewport: !1,
    ...
    extend: function (e, t) {
      ...
      _.iterate (t, function (r) {
        typeof t[r] == n
          ? (typeof e[r] != n && (e[r] = {}), _.extend (e[r], t[r]))
          : (e[r] = t[r]);
      });
    },
    parseMeasurement: function (e) {
      ...
      if (typeof e != 'string') t = [e, 'px'];
        ...
        var n;
        (n = e.match (/([0-9\.]+)([^\s]*)/)), n.length < 3 || !n[2]
          ? (t = [parseFloat (e), 'px'])
          : (t = [parseFloat (n[1]), n[2]]);
      }
      return t;
    },
    getDevicePixelRatio: function () {
      ...
      if (
        ...
        (_.vars[e] == 'android' &&
          r.match (/Safari\/([0-9]+)/) &&
          parseInt (RegExp.$1) >= 537)
      )
        return 1;
      if (window[t] !== undefined && !r.match (/(Firefox; Mobile)/))
        return window[t];
      if (window[n]) {
        if (
          window[n] (
    ...
    getViewportWidth: function () {
      ...
      return (r = document.documentElement.clientWidth), (i = window[e] !==
        undefined
        ? Math.abs (window[e])
        : !1), (s = _.getDevicePixelRatio ()), screen[t] < r &&
        (r = screen[t]), i !== !1 &&
        (_.config.useOrientation
          ? i === 90
              ? (r = Math.max (screen[t], screen[n]))
              : (r = Math.min (screen[t], screen[n]))
          : (r = Math.min (screen[t], screen[n]))), (r /= s), r;
    },
    unlock: function () {
      (_.lockState = null), (document.cookie =
        _.lsc +
        '=;expires=Thu, 1 Jan 1970 12:00:00 UTC; path=' +
        (_.config.useDomainLock ? '/' : window.location.pathname)), _.config
        .pollOnLock
        ? _.poll ()
        : window.location.reload ();
    },
    lock: function (e) {
      (_.lockState = e), (document.cookie =
        _.lsc +
        '=' +
        e +
        ';expires=' +
        (_.config.usePerpetualLock ? 'Thu, 1 Jan 2077 12:00:00 UTC' : 0) +
        '; path=' +
        (_.config.useDomainLock ? '/' : window.location.pathname)), _.config
        .pollOnLock
        ? _.poll ()
    ...
    reverseRows: function (e) {
      ...
      _.iterate (n, function (r) {
        ...
        if (
          i[t] ||
          (e > 0 &&
            i.className.match (/\bno-collapse-([0-9])\b/) &&
            parseInt (RegExp.$1) >= e)
        )
          return;
        var s = i.children, o;
    ...
    registerLocation: function (e, t) {
      ...
      e == 'head'
        ? (t[n] = function (e) {
            this === _.me.parentNode
              ? this.insertBefore (e, _.me)
              : this[r] (e);
          })
        : (t[n] = function (e) {
            this[r] (e);
    ...
    cacheBreakpointElement: function (e, t, n, r, i) {
      ...
      return o || (o = _.cacheElement (t, n, r, i)), _[s][e] &&
        _[s][e].elements.push (o), o;
    },
    ...
    poll: function () {
      ...
      _.lockState
        ? (s = _.lockState)
        : (s = _.getViewportWidth ()), (_.vars.viewportWidth = s), (_.vars.devicePixelRatio = _.getDevicePixelRatio ()), _.iterate (
        _[e],
        function (t) {
          _[e][t].test (s) && (o += _.sd + t);
        }
      ), o === '' && (o = _.sd), o !== _[t] &&
        ((_[r].html[n] = _[r].html[n].replace (_[t], '')), _.changeState (
          o
        ), (_[r].html[n] = _[r].html[n] + _[t]));
    },
    ...
    changeState: function (e) {
      ...
      if (!_[i][r][_[n]]) {
        (_[i][r][_[n]] = {config: {}, elements: [], values: {}}), (F =
          _[i][r][_[n]]), _[n] === _.sd
          ? (B = [])
          : (B = _[n].substring (1).split (_.sd)), _.extend (
          F[s],
          _.defaults.config_breakpoint
        ), _[o] (B, function (e) {
          ...
          ((R = 'iBM'), (q = _[a] (R)) ||
            (q = _[f] (
              R,
              _[l] (
                '*,*:before,*:after{-moz-@;-webkit-@;@}'.replace (
                  /@/g,
                  'box-sizing:' + _[s].boxModel + '-box'
                )
              ),
              c,
              3
            )), F[p][h] (q)), _[s].resetCSS
          ? ((R = 'iR'), (q = _[a] (R)) ||
              (q = _[f] (R, _[l] (_.css.r), c, 2)), F[p][h] (q))
          : _[s].normalizeCSS &&
              ((R = 'iN'), (q = _[a] (R)) ||
                (q = _[f] (R, _[l] (_.css.n), c, 2)), F[p][h] (q)), _[s][d] &&
          ((R = 'ssB'), (q = _[a] (R)) ||
            (q = _[f] (R, _[v] (_[s][d] + m), c, 4)), F[p][h] (q)), (U =
          F[s][g]), F[s][y]
          ? (U += (U != '' ? b : '') + 'width=' + F[s][y])
          : F[s][w] && (U += (U != '' ? b : '') + 'width=device-width'), F[s][
          w
        ] &&
          (U +=
            (U != '' ? b : '') +
            'initial-scale=1.0,minimum-scale=1.0,maximum-scale=1.0'), U != '' &&
          ((R = 'mV' + _[n]), (q = _[a] (R)) ||
            (q = _[f] (R, _.newMeta (g, U), c, 1)), F[p][h] (q)), _[t]
          .IEVersion >= 10 &&
          ((R = 'mVIE' + _[n]), (q = _[a] (R)) ||
            (q = _[f] (
              R,
              _[l] ('@-ms-viewport{width: device-width}'),
              c,
              2
            )), F[p][h] (q));
        var W, X;
        (I = _[E] (F[s][S])), (W = I[0]), (X = I[1]), (F.values[S] =
          W + X), (R = 'iC' + W + X);
        if (!(q = _[a] (R))) {
          var V, $, J;
          (V = W * 0.75 + X), ($ = W + X), (J = W * 1.25 + X), (q = _[f] (
            R,
            _[l] (
              'body{min-width:' +
                $ +
        ...
        F[p][h] (q), (R = 'iG'), (q = _[a] (R)) ||
          ...
          (q = _[f] (
            ...
            c,
            3
          )), F[p][h] (q), (R = 'iGG' + F[s][N][T]);
        if (!(q = _[a] (R))) {
          var K, Q, G, Y, Z, et, tt;
          (I = _[E] (F[s][N][T])), (K = I[0]), (Q = I[1]), (G = K + Q), (Y =
            K / 2 + Q), (Z = K / 4 + Q), (et = K * 1.5 + Q), (tt =
            K * 2 + Q), (q = _[f] (
            'iGG' + F[s][N][T],
            _[l] (
              '.row.flush{margin-left:0}.row.flush>*{padding:0!important}.row>*{padding-left:' +
                G +
                x +
                '.row+.row>*{padding:' +
                G +
        ...
        if (F[s][N][k]) {
          ...
          if (!(q = _[a] (R))) {
            ...
            switch (nt) {
              ...
              default:
                U +=
                  ':not(.no-collapse-1):not(.no-collapse-2):not(.no-collapse-3)';
            }
            (I = _[E] (F[s][N][T])), (z = I[0] / 2 + I[1]), (q = _[f] (
              R,
              _[l] (
                L +
                  U +
        ...
        if (!(q = _[a] (R))) {
          ...
          var rt =
            (U[A] > 0 ? U.join (b) + O : '') + (z[A] > 0 ? z.join (b) + O : '');
          (q = _[f] (R, _[l] (rt.replace (/\.([0-9])/, '.\\3$1 ')), c, 3)), F[
            p
          ][h] (q);
        }
        _[o] (B, function (e) {
          _[u][B[e]][s].hasStyleSheet &&
            _[s][d] &&
            ((R = 'ss' + B[e]), (q = _[a] (R)) ||
              (q = _[f] (R, _[v] (_[s][d] + '-' + B[e] + m), c, 5)), F[p][h] (
              q
            )), _[u][B[e]][p][A] > 0 &&
            _[o] (_[u][B[e]][p], function (t) {
              F[p][h] (_[u][B[e]][p][t]);
            });
        });
      } else F = _[i][r][_[n]];
      _.detachAllElements (), _.attachElements (F[p]), _.DOMReady (function () {
        ...
        _[s].useRTL && (_.unreverseRows (), i > 0 && _.reverseRows (i)), _[t]
          .IEVersion > 8 &&
          ((n =
            '_skel_cell_important_placeholder'), (e = _.getElementsByClassName (
            'skel-cell-important'
          )), e &&
            e[A] > 0 &&
            _[o] (e, function (t) {
              ...
              var r = e[t], s = r[M], o;
              if (!s) return;
              s.className.match (/no-collapse-([0-9])/)
                ? (o = parseInt (RegExp.$1))
                : s.className.match (/no-collapse/) ? (o = 100) : (o = 0);
              if (o < i) {
                if (r[D] (n) && r[n] !== P) return;
                (s = document.createElement ('div')), (s.innerHTML =
                  ''), (s.style.display = 'none'), r[M][H] (
                  s,
                  r.nextSibling
                ), r[M][H] (r, r[M].firstChild), (r[n] = s);
              } else r[D] (n) || (r[n] = P), (s = r[n]), s !== P && (r[M][H] (r, s), r[M].removeChild (s), (r[n] = P));
            }));
      }), (_[t].state = _[i][r][_[n]]), (_[t][n] = _[n]), _.trigger (
        'stateChange'
      );
    },
    ...
    newInline: function (e) {
      ...
      return _.vars.IEVersion <= 8
        ? ((n = document[t] ('span')), (n.innerHTML =
            '&nbsp;<style type="text/css">' + e + '</style>'))
        : ((n = document[t] ('style')), (n.type =
            'text/css'), (n.innerHTML = e)), n;
    },
    newDiv: function (e) {
    ...
    registerPlugin: function (e, t) {
      (_.plugins[e] = t), (t._ = this), _.isConfigured &&
        (_.initPluginConfig (e, _.plugins[e]), t.init ());
    },
    initPluginConfig: function (id, o) {
      var s, k = '_skel_' + id + '_config';
      window[k]
        ? (s = window[k])
        : ((s = document.getElementsByTagName ('script')), (s = s[
            s.length - 1
          ].innerHTML.replace (/^\s+|\s+$/g, '')), s &&
            (s = eval ('(' + s + ')'))), typeof s == 'object' &&
        (s.preset && o.presets[s.preset]
          ? (_.extend (o.config, o.presets[s.preset]), _.extend (o.config, s))
          : _.extend (o.config, s));
    },
    initConfig: function () {
      function buildTest (e, t) {
        ...
        return typeof t != 'string' &&
          ...
          : t.charAt (0) == n
              ? ((fArgs[e] = parseInt (t.substring (1))), (r = function (t) {
                  return t <= fArgs[e];
                }))
      ...
      window._skel_config
        ...
        : ((s = _.me.innerHTML.replace (/^\s+|\s+$/g, '')), s &&
            (s = eval ('(' + s + ')'))), (function () {
        var e = 'object',
          t = 'preset',
          n = 'breakpoints',
        ...
        typeof s == e &&
          (s[t] && _.presets[s[t]]
            ? ((_[r][n] = {}), _[i] (_[r], _.presets[s[t]]), _[i] (_[r], s))
            : (s[n] && (_[r][n] = {}), _[i] (_[r], s))), _[i] (
          _[u][o].grid,
          _[r].grid
        ), (_[u][o][a] = _[r][a]), _.iterate (_[r][n], function (t) {
          typeof _[r][n][t] != e &&
            (_[r][n][t] = {
              range: _[r][n][t],
    ...
    initAPI: function () {
      ...
      (_[e].IEVersion = u[t] (/MSIE ([0-9]+)\./) ? RegExp.$1 : 99), (_[e][n] =
        'other'), (o = {
      ...
      switch (_[e][n]) {
        case 'ios':
          u[t] (/([0-9_]+) like Mac OS X/), (s = parseFloat (
            RegExp.$1[r] (i, '.')[r] (i, '')
          ));
          break;
        case 'android':
          ...
          break;
        case 'mac':
          u[t] (/Mac OS X ([0-9_]+)/), (s = parseFloat (
            RegExp.$1[r] (i, '.')[r] (i, '')
          ));
          break;
        case 'wp':
      ...
      (_[e].deviceVersion = s), (_[e].isTouch = _[e][n] == 'wp'
        ? navigator.msMaxTouchPoints > 0
        : 'ontouchstart' in window), (s = document.cookie.split (
        ';'
      )), _.iterate (s, function (e) {
        var t = s[e].split ('=');
    ...
    init: function (e, t) {
      ...
      _.initConfig (), _[n] (r, document[i] (r)[0]), _[n] (
        s,
        document[i] (s)[0]
      ), _.DOMReady (function () {
    ...
    preInit: function () {
      var e = 'getElementsByTagName',
        ...
        n = 'isConfigured',
        r = document[e] (t);
      (_.me = r[r.length - 1]), window._skel_config
        ? (_[n] = !0)
        : ((s = document[e] (t)), (s = s[s.length - 1].innerHTML.replace (
            /^\s+|\s+$/g,
            ''
          )), s && (_[n] = !0)), _[n] && _.init ();
    },
