      ...
      rn = {
        ...
        recalcW: function (e) {
          ...
          return (
            typeof e == vt &&
              e.charAt(e[K] - 1) == "%" &&
              (t = Math.floor(jQuery(window)[c]() * (t / 100))),
            t
          );
        },
        recalcH: function (e) {
          ...
          return (
            typeof e == vt &&
              e.charAt(e[K] - 1) == "%" &&
              (t = Math.floor(jQuery(window)[T]() * (t / 100))),
            t
          );
        },
        getHalf: function (e) {
          ...
          switch (o.type) {
            case "panel":
              p[ft]("skel-panels-panel")[h](I, rn[v][Bt])[h](s, "fixed").hide(),
                p[tn]("a")
                  [h](H, gt)
                  [Kt]("click.skel-panels", function (r) {
                    var i = jQuery(this);
                    if (rn[e][t] && !i.hasClass("skel-panels-ignore")) {
                      ...
                      var s = i[it]("href"),
                        o = i[it]("target");
                      rn[e][t][n](),
                        i.hasClass("skel-panels-ignoreHref") ||
                          window[b](function () {
                            o == "_blank" && rn._[q][A] != "wp"
                              ? window.open(s)
                ...
                rn._[q][A] == "ios" &&
                  p[tn]("input,select,textarea").focus(function (n) {
                    var r = jQuery(this);
                    n[w](),
                      n[g](),
                      window[b](function () {
            ...
            case Et:
              p[h](I, rn[v][Bt])[h](s, "fixed")[ft]("skel-panels-overlay"),
                ...
                rn._[lt](D, function (e) {
                  p[h](e, D[e]),
                    D[e] == _ &&
                      (e == M
                        ? p[h]("margin-top", "-" + rn.getHalf(a[T]))
                        : e == x &&
                          p[h]("margin-left", "-" + rn.getHalf(a[c])));
                });
              break;
            default:
          }
        ...
        initElements: function (e) {
          ...
          rn._[lt](rn[v][e + "s"], function (n) {
            (t = {}),
              ...
              t.html || (s[n] = r),
              t.breakpoints
                ? (i = t.breakpoints.split(","))
                : (i = rn._.breakpointList),
              rn._[lt](i, function (s) {
                ...
                (o[v] = t),
                  ...
                  (o.onAttach = function () {
                    this[Lt]
                      ? rn.resumeElement(this)
                      : (rn.initElement(this), (this[Lt] = St));
                  }),
                  (o.onDetach = function () {
        ...
        initJQueryUtilityFuncs: function () {
          (jQuery.fn[m] = function (e) {
            return (
              (this[Xt] = this[h](I)), this[h](I, rn[v][Bt] + (e ? e : 1)), this
            );
          }),
            ...
            (jQuery.fn[tt] = function () {
              var e = jQuery(this);
              e[it]("class").match(/(\s+|^)([0-9]+)u(\s+|$)/) &&
                e.data(zt, parseInt(RegExp.$2));
            }),
          ...
          if (
            ...
            (jQuery.fn[i] = function () {
              ...
              (jQuery.fn[O] = function () {
                return jQuery(this)
                  [h]("backface-visibility", Mt)
                  [h]("perspective", "500")
                  [jt](
                    "transition",
                    "transform " + rn[v][at] / 1e3 + "s ease-in-out"
                  );
              });
          else {
            var t,
            ...
            rn[e][C].resize(function () {
              ...
              (jQuery.fn[i] = function () {
                for (var t = 0; t < this[K]; t++) {
                  var i = this[t],
                    s = jQuery(i);
                  n[i.id] &&
                    s.animate(n[i.id], rn[v][at], "swing", function () {
              ...
              (jQuery.fn[f] = function (t, i) {
                ...
                (t = parseInt(t)),
                  (i = parseInt(i)),
                  t != 0
                    ? (rn[e][Vt][h](rt, Mt), rn[e][r][h](c, rn[e][C][c]()))
                    : (f = function () {
                        rn[e][Vt][h](rt, Nt), rn[e][r][h](c, mt);
                      }),
                  i < 0
                    ? rn[e][r][h](F, Math.abs(i))
                    : (l = function () {
                        rn[e][r][h](F, 0);
                      });
                for (o = 0; o < this[K]; o++) {
                  ...
                  if (!n[p.id])
                    if ((m = rn[wt][Zt][d.data(j)])) n[p.id] = m;
                      ...
                      n[p.id] = {};
                      for (u = 0; m[u]; u++)
                        n[p.id][m[u]] = parseInt(d[h](m[u]));
                    } else (m = d[s]()), (n[p.id] = { top: m[M], left: m[x] });
                  (a = {}),
                    rn._[lt](n[p.id], function (e) {
                      var r;
                      switch (e) {
                        case M:
                          r = rn[pt](n[p.id][e]) + i;
          ...
          (rn[e][C] = jQuery(window)),
            ...
            rn._[Gt](function () {
              (rn[e][Vt] = jQuery(Vt)),
                ...
                (rn[e][st] = jQuery('<div id="skel-panels-defaultWrapper" />')[
                  _t
                ](rn[e][Vt])),
                rn[e][st][h](T, Y),
                (rn[e][l] = jQuery('<div id="skel-panels-fixedWrapper" />')[_t](
                  rn[e][Vt]
                )),
                rn[e][l][h](s, Qt),
        ...
        init: function () {
          ...
          if (
            (rn._[q][A] == en && rn._[q].deviceVersion < 4) ||
            rn._[q][A] == "wp"
          )
            rn[v].useTransform = Z;
          rn.initObjects(),
